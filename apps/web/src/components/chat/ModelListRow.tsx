...
import { FLOATING_SQUIRCLE_ITEM_CLASS_NAME } from "../ui/floatingSquircle";
...
export const ModelListRow = memo(function ModelListRow(props: {
  ...
  const row = (
    <ComboboxItem
      ...
      className={cn(
        "group relative w-full !min-w-0 max-w-full cursor-pointer px-2 py-2 transition-[background-color,box-shadow,color]",
