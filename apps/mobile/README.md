...
> [!WARNING]
> FACT3 Code Mobile is currently in development and is not distributed yet. If you want to try it out, you can build it from source.
...
- `development`: Expo dev client, installable side-by-side as `FACT3 Code Dev`
- `preview`: persistent internal preview build, installable side-by-side as `FACT3 Code Preview`
- `production`: store/release build as `FACT3 Code`
